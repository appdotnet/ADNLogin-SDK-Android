...
public class ADNPassportUtility {
    ...
    /**
     * Check to see if App.net Passport is available for third party application authorization.
     *
     ...
     *
     * @param context Context
     * @return true if the Find Friends Activity can be launched, false otherwise.
     */
    ...
    /**
     * Check to see if App.net Passport's Recommended Users Activity can be launched.
     *
     * @param context Context
     * @return true if the Recommended Users Activity can be launched, false otherwise.
     */
    ...
    /**
     * Check to see if App.net Passport's Invite Friends Activity can be launched.
     *
     * @param context Context
     * @return true if the Invite Friends Activity can be launched, false otherwise.
     */
     ...
     * @return false if The Find Friends Activity is not available, true otherwise.
     */
     ...
     * @param context Context
     * @param clientId Your client ID.
     * @return false if The Recommended Users Activity is not available, true otherwise.
     */
     ...
     * @param context Context
     * @param clientId Your client ID.
     * @return false if The Invite Friends Activity is not available, true otherwise.
     */
    ...
    /**
     * Launch Google Play to install App.net Passport.
     *
     * You should use {@link net.app.adnlogin.ADNPassportUtility#isPassportAuthorizationAvailable(android.content.Context)}
     * to check if Passport is installed before calling this method.
     *
     * By registering a BroadcastReceiver for action {@link android.content.Intent#ACTION_PACKAGE_ADDED},
     * you can find out when App.net Passport has successfully been installed and perform follow up
     * tasks, e.g. launch the authorization flow.
     *
     * @param context Context
     */
    ...
    /**
     * Get an Intent to be used with App.net Passport's third party app authorization flow.
     * From your Activity, pass this Intent to startActivityForResult. In the onActivityResult
     * method, a resultCode of 1 indicates authorization success. The data Intent will contain
     * three String extras: accessToken, userId, and username.
     *
     * @param clientId Your client ID.
     * @param scope The requested scopes (Comma separated, e.g. "basic,write_post,files,stream")
     * @return an Intent to be used for App.net Passport's third party app authorization flow.
     */
